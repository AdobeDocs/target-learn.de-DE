...
| --- | --- | --- |
| Maximieren Sie den Metrikwert für eine [!DNL Analytics] Metrik | <ul><li>Entfernen [!UICONTROL Vertrauen] Metriken.</li><li>Entfernen [!UICONTROL Steigerung (niedrig)] und [!UICONTROL Steigerung (hoch)]. Keep [!UICONTROL Steigerung (Med)].</li><li>Deaktivieren Sie die Prozentdarstellung aus der [!UICONTROL Konversionsrate] -Spalte, um Verwirrung zu vermeiden. Siehe [Allgemeine Anleitung für A4T](#guidance) unten.</li><li>Benennen Sie die [!UICONTROL Konversion] Metrik auf &quot;Metrik/Besucher&quot;setzen.</li></ul> | <ul><li>Entfernen [!UICONTROL Vertrauen] Metriken.</li><li>Entfernen [!UICONTROL Steigerung (niedrig)] und [!UICONTROL Steigerung (hoch)] Keep [!UICONTROL Steigerung (Med)].</li><li>Deaktivieren Sie die Prozentdarstellung aus der [!UICONTROL Konversionsrate] -Spalte, um Verwirrung zu vermeiden. Siehe [Allgemeine Anleitung für A4T](#guidance) unten.</li><li>Benennen Sie die [!UICONTROL Konversion] Metrik auf &quot;Metrik/Besucher&quot;setzen.</li><li>Stellen Sie sicher, dass die Datums- und Uhrzeitbereiche mit den Werten übereinstimmen, die in der Variablen [!DNL Target] Bericht. Siehe [Allgemeine Anleitung für A4T](#guidance) unten.</li></ul> |
...
| Erforderliche Änderungen | Von Target ausgelöster Bericht | A4T-Bereichsbericht |
| --- | --- | --- |
| [!DNL Analytics] Reporting mit [!DNL Target] Konversionsmetrik | <ul><li>Entfernen [!UICONTROL Vertrauen] Metriken.</li><li>Entfernen [!UICONTROL Steigerung (niedrig)] und [!UICONTROL Steigerung (hoch)]. Steigerung beibehalten (Med).</li><li>Deaktivieren Sie die Prozentdarstellung aus der [!UICONTROL Konversionsrate] -Spalte, um Verwirrung zu vermeiden. Siehe [Allgemeine Anleitung für A4T](#guidance) unten.</li></ul> | <ul><li>Entfernen [!UICONTROL Vertrauen] Metriken.</li><li>Entfernen [!UICONTROL Steigerung (niedrig)] und [!UICONTROL Steigerung (hoch)]. Keep [!UICONTROL Steigerung (Med)].</li><li>Deaktivieren Sie die Prozentdarstellung aus der [!UICONTROL Konversionsrate] -Spalte, um Verwirrung zu vermeiden. Siehe [Allgemeine Anleitung für A4T](#guidance) unten.</li><li>Stellen Sie sicher, dass die Datums- und Uhrzeitbereiche mit den Werten übereinstimmen, die in der Variablen [!DNL Target] Bericht. Siehe [Allgemeine Anleitung für A4T](#guidance) unten.</li></ul> |
...
Sie können zu einer vordefinierten [!UICONTROL Analytics for Target] durch Klicken auf den Link im Berichtsbildschirm in [!UICONTROL Target] (Dies wird weiter unten in diesem Handbuch als[!DNL Target]-ausgelöster Bericht&quot;). Alternativ können Sie das A4T-Bedienfeld in [!DNL Analytics] (Details finden Sie weiter unten in diesem Abschnitt).
...
1. Deaktivieren Sie die **[!UICONTROL Prozent]** aktivieren.
   ...
   Ihr A4T-Bedienfeld enthält jetzt keine Prozentsätze als [!UICONTROL Konversionsrate] und stimmt überein [!DNL Target], wie unten dargestellt:
...
1. Überprüfen Sie unter jedem Bereich den Datumsbereich, auf den der Bereich verweist, um sicherzustellen, dass der Datumsbereich mit dem der [!DNL Target] Bericht.
