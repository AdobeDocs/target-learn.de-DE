...
Manchmal haben Sie auch Ziele, die zunächst nicht greifbar erscheinen, wie z. B. Markenwert oder Loyalität. Es ist wichtig, dass Sie diese messen können, um sie als Zielmetriken für Personalization-Aktivitäten zu verwenden. In der Regel können diese Zieltypen weiterhin an den Umsatzauswirkungen ausgerichtet werden, z. B. an dem lebenslangen Kundennutzen oder den Akquisitionskosten.Wenn Sie Fortschritte machen, sollten Sie die Programmleistung in regelmäßigen Abständen anhand Ihrer wichtigsten Geschäftsziele überprüfen, um sicherzustellen, dass Ihr Personalization-Programm von Nutzen ist.
